      ...
      <div className="max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-gray-500 mb-8">
            {pendingTickets.length} ticket{pendingTickets.length !== 1 ? 's' : ''} pendiente{pendingTickets.length !== 1 ? 's' : ''} de validacion
          </p>
        </motion.div>
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-gray-500">No hay tickets pendientes de validacion</p>
          </motion.div>
        ) : (
                      ...
                      <div className="space-y-3 flex-1">
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            ...
                            style={{ color: '#FF9800', background: '#FF980015' }}
                          >
                            Pendiente
                          </span>
                        </div>
                        <p className="text-gray-400 text-sm">{ticket.prizes?.name}</p>
                          ...
                          <div className="mt-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {ticket.receipts.map((receipt, ri) => (
                                <button
                                  key={ri}
                                  onClick={() => setPreviewUrl(receipt.file_url)}
