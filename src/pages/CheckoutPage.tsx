...
interface ReservedTicket {
  ...
  prizes: { name: string; ticket_price: number };
}
...
export default function CheckoutPage() {
  ...
  const fetchReserved = useCallback(async () => {
    ...
    const { data } = await supabase
      .from('tickets')
      .select('id, ticket_number, prize_id, reservation_expires_at, prizes(name, ticket_price)')
  ...
  const handleWhatsApp = () => {
    const msg = encodeURIComponent(
      `Hola! Mi nombre es ${profile?.full_name || user?.email}. Reserve los tickets #${ticketNumbers} para "${prizeName}". Adjunto mi comprobante de pago.`
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#101010' }}>
        ...
        >
          ...
          <h2 className="text-xl font-bold text-white mb-2">No tienes tickets reservados</h2>
          <p className="text-gray-500 mb-6">Selecciona tickets desde la pagina principal</p>
          <button
            onClick={() => navigate('/')}
    ...
    <div className="min-h-screen pt-16 pb-20 px-4" style={{ background: '#101010' }}>
      ...
      <div className="max-w-2xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-gray-500 mb-8">Completa tu pago para confirmar tus tickets</p>
        </motion.div>
          ...
          {success ? (
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Tu comprobante esta siendo validado. Recibiras la confirmacion pronto.
              </p>
            ...
            >
                  ...
                  {reservedTickets.map((t) => (
                    ...
                    >
                      <div>
                        ...
                        <span className="text-gray-500 text-sm ml-2">{t.prizes?.name}</span>
                      </div>
                      <span className="font-semibold" style={{ color: GOLD }}>
                        ${t.prizes?.ticket_price?.toLocaleString()} CLP
                      </span>
                    </div>
                  ))}
                </div>
              ...
              <div className="rounded-2xl border border-gray-800 p-6" style={{ background: '#141414' }}>
                ...
                <p className="text-gray-500 text-xs mt-3">
                  Transfiere el monto exacto y sube tu comprobante a continuacion.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-800 p-6" style={{ background: '#141414' }}>
                ...
                <div
                  ...
                  className={`
                    ...
                    ${dragOver ? 'border-yellow-500 bg-yellow-500/5' : 'border-gray-700 hover:border-gray-600'}
                  `}
              ...
              <div className="rounded-2xl border border-gray-800 p-6" style={{ background: '#141414' }}>
                ...
                <p className="text-gray-400 text-sm mb-4">
                  Tambien puedes enviar tu comprobante por WhatsApp para validacion mas rapida.
                </p>
                <button
                ...
                >
                  ...
                  {whatsappSent ? 'Abrir WhatsApp de nuevo' : 'Enviar por WhatsApp'}
                </button>
                {whatsappSent && (
