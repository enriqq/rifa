...
const WINNING_NUMBERS = [/* Pon aquí los números ganadores, ejemplo: */ 12, 45, 78];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black px-4 py-12">
      <div className="max-w-2xl w-full text-center">
        <h1 className="text-4xl font-bold text-yellow-400 mb-6">¡Ganadores de la Rifa!</h1>
        ...
        <h2 className="text-2xl text-white font-semibold mb-4">Video de la rifa en vivo</h2>
        <div className="mb-8">
          <video
            src={VIDEO_URL}
            controls
        ...
        <p className="text-gray-400">
          Si eres uno de los ganadores, revisa tu correo para reclamar tu premio.
        </p>
      </div>
    </div>
  );
